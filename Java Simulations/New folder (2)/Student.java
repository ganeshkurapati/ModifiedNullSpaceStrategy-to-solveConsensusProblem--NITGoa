...
//                   }
        ...
        if ((x_me>=1)&&(x_me<=20)&&(y_me>=10)&&(y_me<=30)&&(dist10>=8)) 
        {   
            students.i_obst=1;
        ...
        double dist110=length(1-x_me,0);
        if ((y_me<=20)&&(y_me>=40)&&(dist110<=2))
        {
            students.i_obst=1;
            x_o=1;y_o=y_me;
        }
        
        double dist120=length(0,40-y_me);
        if ((x_me>=1)&&(x_me<=21)&&(dist120<=2))
        {
            students.i_obst=1;
            x_o=x_me;y_o=40;
        }
        
        double dist130=length(21-x_me,0);
        if ((y_me<=20)&&(y_me>=40)&&(dist130<=2))
        {
            students.i_obst=1;
            x_o=21;y_o=y_me;
        }
...
//             double dist_w1=length(x_g-(x_me+x_temp*10* students.GoToGoalMultiplier),y_g-(y_me+y_temp *10* students.GoToGoalMultiplier));
//             if((dist_w1<students.dist_w[0][students.i_imp])&&((x_g-x_me)*(x_me-x_o)+(y_g-y_me)*(y_me-y_o)>0))
//             {
//              students.wallf[0][students.i_imp]=0;
//              students.wallf1[0][students.i_imp]=0;
