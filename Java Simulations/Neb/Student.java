...
public class Student implements Steppable
    ...
    public void step(SimState state)
        ...
        double x_g=50.0;double y_g=50.0;
...
//                   }
            ...
            double x_temp= ((x_me-x_n11)/dist)+(((1-(x_me-x_n11)*(x_me-x_n11))*(x_g-x_me)-(x_me-x_n11)*(y_me-y_n11)*(y_g-y_me))/(dist*dist))*0.05;
            double y_temp= ((y_me-y_n11)/dist)+(((1-(y_me-y_n11)*(y_me-y_n11))*(y_g-y_me)-(x_me-x_n11)*(y_me-y_n11)*(x_g-x_me))/(dist*dist))* 0.05;
            sumForces.addIn(new Double2D((x_temp) , (y_temp) ));
             ...
             double x_n1=Neb[1][0];
             double y_n1=Neb[2][0];
             double aa= ((x_me-x_n1)/dist1)+(((1-(x_me-x_n1)*(x_me-x_n1))*(a)-(x_me-x_n1)*(y_me-y_n1)*(b))/(dist1*dist1))*0.05;
             double bb= ((y_me-y_n1)/dist1)+(((1-(y_me-y_n1)*(y_me-y_n1))*(b)-(x_me-x_n1)*(y_me-y_n1)*(a))/(dist1*dist1))* 0.05;
