...
public class Students extends SimState
    ...
    public static final double[][] obstInfo = { {20, 40, 40},{20,30,40},{2,90,65},{20,30,70},{20,65,60},{20,70,30} };
...
//            
            ...
            if(i==0){x_int=6;y_int=34;}
            if(i==1){x_int=12;y_int=36;}
            //if(i==2){x_int=5;y_int=30;}
            if(i==2){x_int=14;y_int=38;}
            //if(i==3){x_int=52;y_int=2;}
            if(i==3){x_int=46;y_int=6;}
            if(i==4){x_int=48;y_int=8;}
            if(i==5){x_int=50;y_int=4;}
            if(i==6){x_int=15;y_int=70;}
            if(i==7){x_int=15;y_int=72;}
            if(i==8){x_int=10;y_int=74;}
           if(i==9){x_int=10;y_int=76;}
