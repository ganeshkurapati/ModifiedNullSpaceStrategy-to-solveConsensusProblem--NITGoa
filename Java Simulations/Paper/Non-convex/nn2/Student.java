...
public class Student implements Steppable
    ...
    public void step(SimState state)
        ...
        double x_g=90.0;double y_g=65.0;
...
//                   }
            ...
            double dist_o1=length(65-x_me,60-y_me);
            ...
            double dist_o2=length(70-x_me,30-y_me);
            ...
            if((18 <= x_me) && (x_me <= 42)){
           double dist11=length(0,y_me-60);
            if(dist11<=2){students.i_obst=1;
             x_o=x_me;y_o=60;}
                         
           double dist22=length(0,y_me-80);
           if(dist22<=2){students.i_obst=1;
            x_o=x_me;y_o=80;}
            }
        
           if((59 <= y_me) && (y_me <= 81)){
           double dist11=length(x_me-20,0);
           if(dist11<=2){students.i_obst=1;
            x_o=20;y_o=y_me;}
                         
           double dist22=length(x_me-40,0);
            if(dist22<=2){students.i_obst=1;
            x_o=40;y_o=y_me;}
            }
           ...
           double dist10=length(30-x_me,40-y_me);
        if ((x_me>=30)&&(y_me>=32)&&(y_me<=48)&&(dist10>=8)&&(dist10<=9)) 
        {   
            students.i_obst=1;
            x_o=30+10*Math.cos(Math.atan((y_me-40)/(x_me-30)));
            y_o=40+10*Math.sin(Math.atan((y_me-40)/(x_me-30)));
        }
        
        double dist110=length(30-x_me,0);
        if ((y_me<=33)&&(y_me>=29)&&(dist110<=2))
        {
            students.i_obst=1;
            x_o=32;y_o=y_me;
        }
        
        double dist120=length(0,30-y_me);
        if ((x_me>=30)&&(x_me<=50)&&(dist120<=2))
        {
            students.i_obst=1;
            x_o=x_me;y_o=30;
        }
        
        double dist130=length(30-x_me,0);
        if ((y_me<=51)&&(y_me>=47)&&(dist130<=2))
        {
            students.i_obst=1;
            x_o=32;y_o=y_me;
        }
        
        double dist140=length(0,50-y_me);
        if ((x_me>=30)&&(x_me<=50)&&(dist140<=2))
          {
            students.i_obst=1;
            x_o=x_me;y_o=50;
          }
            ...
            if((students.i_obst==1)&&(n_it==0))
            {
             ...
             sumForces.addIn(new Double2D((x_temp)*10* students.GoToGoalMultiplier, (y_temp) *10* students.GoToGoalMultiplier)); 
