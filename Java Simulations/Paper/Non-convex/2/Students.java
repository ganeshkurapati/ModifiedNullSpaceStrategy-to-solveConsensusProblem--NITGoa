...
public class Students extends SimState
    ...
    public static final double[][] obstInfo = { {20, 40, 40},{20,30,40},{2,70,40} };
...
//            
            ...
            if(i==2){x_int=10;y_int=42;}
            if(i==3){x_int=12;y_int=42;}
            if(i==4){x_int=55;y_int=90;}
            if(i==5){x_int=43;y_int=90;}
            if(i==6){x_int=41;y_int=90;}
