...
//                   }
           ...
           if ((x_me>=30)&&(y_me>=30)&&(y_me<=50)&&(dist10>=8)) 
            {
                students.i_obst=1;
            ...
            double x_temp_o= ((x_me-x_o)*1.2/dist_o)+(((1-(x_me-x_o)*(x_me-x_o))*(x_g-x_me)-(x_me-x_o)*(y_me-y_o)*(y_g-y_me))/(dist_o*dist_o));
            double y_temp_o= ((y_me-y_o)*1.2/dist_o)+(((1-(y_me-y_o)*(y_me-y_o))*(y_g-y_me)-(x_me-x_o)*(y_me-y_o)*(x_g-x_me))/(dist_o*dist_o));
