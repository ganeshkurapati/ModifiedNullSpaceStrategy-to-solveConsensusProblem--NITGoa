...
public class Student implements Steppable
    ...
    public void step(SimState state)
        ...
        double x_g=90.0;double y_g=40.0;
...
//                   }
            ...
            double dist_o1=length(70-x_me,60-y_me);
            ...
            double dist_o2=length(70-x_me,20-y_me);
            ...
            if((18 <= x_me) && (x_me <= 42)){
           double dist11=length(0,y_me-70);
            if(dist11<=2){students.i_obst=1;
             x_o=x_me;y_o=70;}
                         
           double dist22=length(0,y_me-90);
