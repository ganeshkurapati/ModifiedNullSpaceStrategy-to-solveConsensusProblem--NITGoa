...
%             obj.p = simiam.util.Plotter();
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            sensor_gains = [1 1 1 0 0 1 1 1 0];
...
%             for p=1:9
%                 z(p)=ir_distances(p);
%                 alpha1(p)=-5.5556*z(p)+1.1111;
%             end
%             alpha=(3.5*alpha1(1)+2.5*alpha1(2)+2.5*alpha1(3)+alpha1(4)+alpha1(5)+2.5*alpha1(6)+2.5*alpha1(7)+3.5*alpha1(8))/6;
             alpha=0.5;
            u_ao_gtg=(1-alpha)*u_gtg+(alpha)*u_ao;
