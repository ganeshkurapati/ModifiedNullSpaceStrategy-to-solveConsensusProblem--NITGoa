...
% see the LICENSE file included with this software
    ...
    methods
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            sensor_gains = [0 1 0.8 0.1 0.1 0.8 0.2 1 0];
            %sensor_gains =  [1 1   1   1 1 1   1   1 0];
            %sensor_gains = ones(1,9);
            x_matrix=[];
            for i=1:9
                x_matrix=[x_matrix [x;y]];
            end
            %ir_distances_rf
            %x_matrix
            
            %u_i = zeros(2,9);
            u_i= +ir_distances_rf-x_matrix; % Vector poinintg away from the obstacle
            u=u_i*sensor_gains';
...
%             fprintf('(v,w) = (%0.4g,%0.4g)\n', v,w);
        ...
        function ir_distances_rf = apply_sensor_geometry(obj, ir_distances, state_estimate)
            ...
            for i=1:9
                ...
                distance_robot=ir_distances(i);
                vector_robot=[distance_robot 0 1]';
                ir_distances_sf(:,i)=R*vector_robot;
                %% END CODE BLOCK %%
            end
